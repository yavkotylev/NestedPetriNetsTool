...
public class NestedPetriNet extends PApplet {
...
public class ElementMenu {
  ...
  public boolean checkPoint(float y) {
  ...
  public boolean checkPress(float y) {
...
public class Place {
  ...
  public void shift(float amendmentX, float amendmentY) {
...
public class Arc {
  ...
  public void draw(int i) {
    if (type.equals("circular")) {
      ...
      ellipse(place.scaledPlaceX, (place.scaledPlaceY + place.scaledPlaceDiameter), 
        place.scaledPlaceRadius * 0.9f, place.scaledPlaceDiameter);
      translate(0, 0, 0.003f);
  ...
  public void drawArrow(float x0, float y0, float x1, float y1, float beginHeadSize, float endHeadSize, boolean filled) {
    PVector d = new PVector(x1 - x0, y1 - y0);
    d.normalize();
    float coeff = 5.0f;
    strokeCap(SQUARE);
...
public void setNet(String selection) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "NestedPetriNet" };
    if (passedArgs != null) {
